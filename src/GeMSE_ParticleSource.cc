...
void GeMSE_ParticleSource::SetParticleDefinition(G4ParticleDefinition * aParticleDefinition)
{
...
void GeMSE_ParticleSource::GeneratePrimaryVertexFromTrack(G4Track *pTrack, G4Event *pEvent)
{
