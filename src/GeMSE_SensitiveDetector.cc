...
void GeMSE_SensitiveDetector::Initialize(G4HCofThisEvent*)
{
	...
	HitsCollection = new GeMSE_HitsCollection
					 (SensitiveDetectorName,collectionName[0]);
	  
	
	GeMSE_RunAction* runAction = (GeMSE_RunAction*) G4RunManager::GetRunManager()->GetUserRunAction(); //get pointer to RunAction
...
G4bool GeMSE_SensitiveDetector::ProcessHits(G4Step* aStep, G4TouchableHistory* ROhist){
