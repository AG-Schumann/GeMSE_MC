...
void GeMSE_ParticleSourceMessenger::SetNewValue(G4UIcommand * command, G4String newValues)
{
	...
	else if(command == m_pParticleCmd)
	{
		...
		if(m_bShootIon){
			...
			G4cout << "Set /GeMSE/gun/particle to ion before using /GeMSE/gun/ion command";
			G4cout << G4endl;
		}
	}
