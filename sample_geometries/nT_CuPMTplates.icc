...
G4double zPosBotLayer_s = zPosCuShielding + zSizeCuShielding/2. - zSizeSampleChamber
                          + 0.5 * dCu_height_s;
G4double zPosBotLayer_l = zPosCuShielding + zSizeCuShielding/2. - zSizeSampleChamber
                          + 0.5 * dCu_height_l;
...
new G4PVPlacement(0,
     G4ThreeVector(-xSizeSampleChamber/2. + 1.5*dCu_width_s + dBrickSeparation,
                   -ySizeSampleChamber/2. + 0.5*dCu_length_l,
                   zPosBotLayer_l),
     CuBrick_g, "CuBrick_Bot_102", expHall_log, false,0);
new G4PVPlacement(0,
     G4ThreeVector(-xSizeSampleChamber/2. + 2.5*dCu_width_s + 2*dBrickSeparation,
                   -ySizeSampleChamber/2. + 0.5*dCu_length_l,
                   zPosBotLayer_l),
     CuBrick_g, "CuBrick_Bot_103", expHall_log, false,0);
new G4PVPlacement(0,
     G4ThreeVector(-xSizeSampleChamber/2. + 3*(dCu_width_s + dBrickSeparation)
                                          + 0.5*dCu_width_l,
                   -ySizeSampleChamber/2. + 0.5*dCu_length_l,
                   zPosBotLayer_l),
     CuBrick_e, "CuBrick_Bot_104", expHall_log, false,0);

G4ThreeVector sample_pos =
     G4ThreeVector(xSizeSampleChamber/2. - 1.5*dCu_length_s - dBrickSeparation,
                   -ySizeSampleChamber/2. + 0.5*dCu_width_s,
                   zPosBotLayer_s);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_105", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(dCu_length_s - dCu_length_l - dBrickSeparation,
                         dCu_width_s + dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_106", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0, dCu_width_s + dBrickSeparation, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_107", expHall_log, false,0);
...
sample_pos =
     G4ThreeVector(xSizeSampleChamber/2. - 0.5*dCu_length_s,
                   ...
                   zPosBotLayer_s);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_108", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_length_s - dCu_length_l),
                         0.5*(dCu_width_s + dCu_width_l)+ dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_b, "CuBrick_Bot_109", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_length_l - dCu_length_s),
                         0.5*(dCu_width_s + dCu_width_l)+ dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_110", expHall_log, false,0);


new G4PVPlacement(0,
     G4ThreeVector(-xSizeSampleChamber/2. + 0.5*dCu_width_s,
                   -ySizeSampleChamber/2. + 1.5*dCu_length_l + dBrickSeparation,
                   zPosBotLayer_l),
...
new G4PVPlacement(0,
     G4ThreeVector(-xSizeSampleChamber/2. + 2*(dCu_width_s + dBrickSeparation)
                                          + 0.5*dCu_width_l,
...
sample_pos =
     G4ThreeVector(-xSizeSampleChamber/2. + 0.5*dCu_length_l,
                   ySizeSampleChamber/2. - 1.5*dCu_width_s
                   - dCu_width_l - 2*dBrickSeparation,
                   zPosBotLayer_s);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_a, "CuBrick_Bot_301", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0, dCu_width_s + dBrickSeparation, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_a, "CuBrick_Bot_302", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_length_s - dCu_length_l),
                         0.5*(dCu_width_s + dCu_width_l) + dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_c, "CuBrick_Bot_303", expHall_log, false,0);
sample_pos =
     G4ThreeVector(-xSizeSampleChamber/2. + 1.5*dCu_length_l + dBrickSeparation,
                   ySizeSampleChamber/2. - 2.5*dCu_width_s - 2*dBrickSeparation,
                   zPosBotLayer_s);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_a, "CuBrick_Bot_304", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_length_s - dCu_length_l),
                         dCu_width_s + dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_d, "CuBrick_Bot_305", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_length_s - dCu_length_l),
                         dCu_width_s + dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_Z,sample_pos),
                  CuBrick_a, "CuBrick_Bot_306", expHall_log, false,0);
new G4PVPlacement(0,
     G4ThreeVector(xSizeSampleChamber/2. - 3.5*dCu_width_s - 3*dBrickSeparation,
...
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_c, "CuBrick_Mid_101", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(- 3.*mm + 0.5*(dCu_height_l - dCu_height_s),
                         dCu_width_l + dBrickSeparation,
                         0.5*(dCu_length_l - dCu_length_s));
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_102", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(+ 3.*mm,
                         dCu_width_l + 4*dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_103", expHall_log, false,0);
...
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_104", expHall_log, false,0);                  
sample_pos = sample_pos
         + G4ThreeVector(-dCu_width_l - dBrickSeparation, - 3.*mm, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_105", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(-dCu_width_l - 3.*mm, + 1.*mm, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_106", expHall_log, false,0);
...
sample_pos =
     G4ThreeVector(-xSizeSampleChamber/2. + 0.5*dCu_width_l + 1.*mm,
                   ...
                   zPosBotLayer_l + 0.5*(dCu_length_l + dCu_height_l));
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_b, "CuBrick_Mid_201", expHall_log, false,0);                  
sample_pos = sample_pos
         + G4ThreeVector(dCu_width_l + dBrickSeparation, 0, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_b, "CuBrick_Mid_202", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(dCu_width_l + dBrickSeparation + 3.*mm,
                         0.5*(dCu_height_s - dCu_height_l) - 2.*mm,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_203", expHall_log, false,0);

rm_bricks_mid.rotateZ(-90.*deg);
sample_pos =
     G4ThreeVector(xSizeSampleChamber/2. - 0.5*dCu_height_s - 3.*mm,
                   ySizeSampleChamber/2. - 2.5*dCu_width_l - 2*dBrickSeparation,
                   zPosBotLayer_l + 0.5*(dCu_length_l + dCu_height_l));
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_b, "CuBrick_Mid_204", expHall_log, false,0);                  
sample_pos = sample_pos
         + G4ThreeVector(0, dCu_width_l + dBrickSeparation, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_b, "CuBrick_Mid_205", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0.5*(dCu_height_s - dCu_height_l) + 2*mm,
                         dCu_width_l + dBrickSeparation,
                         0);
new G4PVPlacement(G4Transform3D(rm_bricks_mid, sample_pos),
                  CuBrick_e, "CuBrick_Mid_206", expHall_log, false,0);
...
sample_pos =
     G4ThreeVector(0,
                   -0.5*(dCu_length_l + dBrickSeparation),
                   zPosBotLayer_l + dCu_length_l
                   + 0.5*(dCu_height_l + dCu_width_l));
new G4PVPlacement(G4Transform3D(rm_bricks_top, sample_pos),
                  CuBrick_e, "CuBrick_Top_1", expHall_log, false,0);
sample_pos = sample_pos
         + G4ThreeVector(0, dCu_length_l + dBrickSeparation, 0);
new G4PVPlacement(G4Transform3D(rm_bricks_top, sample_pos),
                  CuBrick_e, "CuBrick_Top_2", expHall_log, false,0);
...
// Output sample mass
const G4double dCu_ScreenedMass =
         6*CuBrick_a->GetMass(false, false)/g
