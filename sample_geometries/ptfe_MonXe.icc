...
G4double zPosSide = zPosCuShielding + zSizeCuShielding/2. - zSizeSampleChamber
                     + 0.5 * dPTFEbrickSide_z;
G4double zPosTop = zPosEndcap + heightEndcap/2.
                     + 0.5 * dPTFEbrickTop_z;
...
new G4PVPlacement(0, G4ThreeVector(-xSizeSampleChamber/2. + 0.5*dPTFEbrickSide_x,
                                   ySizeSampleChamber/2. - 0.5*dPTFEbrickSide_y,
                                   zPosSide),
                  pSideBrick1_log, "Teflon_LeftBrick",
                  expHall_log, false,0);
                  
new G4PVPlacement(0, G4ThreeVector(xSizeSampleChamber/2. - 0.5*dPTFEbrickSide_x,
                                   -ySizeSampleChamber/2. + 0.5*dPTFEbrickSide_y,
                                   zPosSide),
                  pSideBrick1_log, "Teflon_RightBrick",
                  expHall_log, false,0);

new G4PVPlacement(0, G4ThreeVector(xSizeSampleChamber/2. - 0.5*dPTFEbrickSide_y,
                                   ySizeSampleChamber/2. - 0.5*dPTFEbrickSide_x,
                                   zPosSide),
                  pSideBrick2_log, "Teflon_DownBrick",
                  expHall_log, false,0);

new G4PVPlacement(0, G4ThreeVector(-xSizeSampleChamber/2. + 0.5*dPTFEbrickSide_y,
                                   -ySizeSampleChamber/2. + 0.5*dPTFEbrickSide_x,
                                   zPosSide),
                  pSideBrick2_log, "Teflon_UpBrick",
                  expHall_log, false,0);
                  
new G4PVPlacement(0, G4ThreeVector(0., 0., zPosTop),
                  pTopBrick_log, "Teflon_TopBrick",
                  expHall_log, false,0);
...
G4cout << "\n############################" << G4endl;
G4cout << "Total PTFE mass         : " << 4*sidebrick_mass + topbrick_mass << " g" << G4endl;
G4cout << "############################" << G4endl;
