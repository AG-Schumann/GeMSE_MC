...
G4Box* hvConnectorsBrick =
 new G4Box("hvConnectorsBrick", hvcon_width/2., hvcon_thick/2., hvcon_height/2.);
G4LogicalVolume* hvConnectorsBrick_log =
 new G4LogicalVolume(hvConnectorsBrick, HVconnectors_mat,
                      "hvConnectorsBrick_log",0,0,0);
new G4PVPlacement(0,
 G4ThreeVector(0., 0., zPosHVcon), hvConnectorsBrick_log, "hvConnectorsBrick",
               expHall_log, false,0);
