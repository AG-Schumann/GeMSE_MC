...
G4double zPosSideLow = zPosCuShielding+zSizeCuShielding/2.-zSizeSampleChamber
                       + holders_diameter/2.;
...
G4Tubs* holder_top =
    new G4Tubs("holder_top", 0., holders_diameter/2., holders_top_height/2.,
               0.*deg, 360.*deg);
...
new G4PVPlacement(0, G4ThreeVector(0., 0., zPosTop),
                  holder_top_log, "PTFE_holder_top",
                  expHall_log, false,0);

// Placement side cylinders
G4Tubs* holders_side =
    new G4Tubs("holders_side", 0., holders_diameter/2., holders_side_height/2.,
               0.*deg, 360.*deg);
