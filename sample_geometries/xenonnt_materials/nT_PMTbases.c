...
G4Material *Cirlex_Air = new G4Material("Cirlex_Air", 0.786 * g / cm3, 2, kStateSolid);
...
G4double zPosblockSide =
    zPosCuShielding+zSizeCuShielding/2.-zSizeSampleChamber
    + basesbrick_side/2.;
G4double zPosblockTop = zPosEndcap+heightEndcap/2. + basesbrickside_top/2.;

G4Box* bases_sidebrick1 =
 new G4Box("bases_sidebrick1", basesbrick_side/2.,
                              basesbrickside_thick/2., basesbrick_side/2.);
G4LogicalVolume* bases_sidebrick1_log =
 new G4LogicalVolume(bases_sidebrick1, Cirlex_Air,
                      "bases_sidebrick1_log",0,0,0);
new G4PVPlacement(0,
...
G4LogicalVolume* bases_sidebrick2_log =
 new G4LogicalVolume(bases_sidebrick2, Cirlex_Air,
                     "bases_sidebrick2_log",0,0,0);
new G4PVPlacement(0,
 G4ThreeVector(-(outerRadiusEndcap+10.*mm+basesbrickside_thick/2.), 0.,
               zPosblockSide),
 bases_sidebrick2_log, "bases_sidebrick_2", expHall_log, false,0);

G4Box* bases_topbrick =
 new G4Box("bases_topbrick", basesbrick_side/2.,
                             basesbrick_side/2., basesbrickside_top/2.);
G4LogicalVolume* bases_topbrick_log =
 new G4LogicalVolume(bases_topbrick, Cirlex_Air,
                     "bases_topbrick_log",0,0,0);
new G4PVPlacement(0,
 G4ThreeVector(0., 0., zPosblockTop), bases_topbrick_log, "bases_topbrick",
               expHall_log, false,0);
