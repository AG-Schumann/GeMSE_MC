...
G4double ZZ[] = {dSpoolZ0, dSpoolZ1, dSpoolZ2, dSpoolZ3, dSpoolZ4,
                 dSpoolZ5, dSpoolZ6, dSpoolZ7};

G4double RRout[] = {rSpoolOutBot, rSpoolOutBot,
                    rSpoolOutMid, rSpoolOutMid, rSpoolOutMid, rSpoolOutMid,
                    rSpoolOutTop, rSpoolOutTop};

G4double RRin[] = {rSpoolInBot, rSpoolInBot, rSpoolInBot, rSpoolInBot,
                   rSpoolInMid, rSpoolInMid,
                   rSpoolInTop, rSpoolInTop};

G4double zPosSpool = zPosCuShielding + zSizeCuShielding/2. - zSizeSampleChamber
                     + hSpoolOutBot + 0.5 * hSpoolOutMid;
...
new G4PVPlacement(0, G4ThreeVector(0., 0., zPosWires),
                  wires_log, "Cu_WiresCylinder",
                  expHall_log, false,0);
